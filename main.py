...
async def create_calendar_event():
    ...
    if(identities.google is None):
      return
    creds = Credentials(access_token=identities.google.access_token, refresh_token=identities.google.refresh_token, token_uri="https://oauth2.googleapis.com/token",client_id=os.getenv('GOOGLE_CLIENT_ID'), client_secret=os.getenv('GCP_SECRET'))
