...
async def create_calendar_event():
    ...
    if(identities.google is None):
      return
    creds = Credentials(token=token, refresh_token=identities.google.refresh_token, token_uri="https://oauth2.googleapis.com/token",client_id=os.getenv('GOOGLE_CLIENT_ID'),scopes=SCOPES, client_secret=os.getenv('GCP_SECRET'))
